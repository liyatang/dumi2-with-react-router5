...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('react'), require('@remix-run/router'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'react', '@remix-run/router'], factory)
    : ((global =
        typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory((global.ReactRouter = {}), global.React, global.RemixRouter));
  ...
  function useHref(to, _temp) {
    ...
    if (basename !== '/') {
      joinedPathname =
        pathname === '/' ? basename : router.joinPaths([basename, pathname]);
    }
  ...
  function useMatch(pattern) {
    ...
    return React__namespace.useMemo(
      () => router.matchPath(pattern, pathname),
      [pathname, pattern],
    );
  }
  ...
  function useNavigateUnstable() {
    ...
    let { basename, future, navigator } =
      React__namespace.useContext(NavigationContext);
    let { matches } = React__namespace.useContext(RouteContext);
    let { pathname: locationPathname } = useLocation();
    let routePathnamesJson = JSON.stringify(
      router.UNSAFE_getResolveToMatches(matches, future.v7_relativeSplatPath),
    );
      ...
      function (to, options) {
        ...
        if (dataRouterContext == null && basename !== '/') {
          path.pathname =
            path.pathname === '/'
              ? basename
              : router.joinPaths([basename, path.pathname]);
        }
  ...
  function useResolvedPath(to, _temp2) {
    ...
    let { future } = React__namespace.useContext(NavigationContext);
    let { matches } = React__namespace.useContext(RouteContext);
    let { pathname: locationPathname } = useLocation();
    let routePathnamesJson = JSON.stringify(
      router.UNSAFE_getResolveToMatches(matches, future.v7_relativeSplatPath),
  ...
  function DefaultErrorComponent() {
    ...
    let message = router.isRouteErrorResponse(error)
  ...
  function useDataRouterContext(hookName) {
    ...
    !ctx
      ? router.UNSAFE_invariant(false, getDataRouterConsoleError(hookName))
      : void 0;
    return ctx;
  }
  ...
  function useMatches() {
    ...
    return React__namespace.useMemo(
      () =>
        matches.map((m) =>
          router.UNSAFE_convertRouteMatchToUiMatch(m, loaderData),
        ),
      [matches, loaderData],
    );
  }
  ...
  function useBlocker(shouldBlock) {
    let { router: router$1, basename } = useDataRouterContext(
      DataRouterHook.UseBlocker,
    );
    let state = useDataRouterState(DataRouterStateHook.UseBlocker);
    let [blockerKey, setBlockerKey] = React__namespace.useState('');
    let blockerFunction = React__namespace.useCallback(
      (arg) => {
        ...
        return shouldBlock({
          currentLocation: _extends({}, currentLocation, {
            pathname:
              router.stripBasename(currentLocation.pathname, basename) ||
              currentLocation.pathname,
          }),
          nextLocation: _extends({}, nextLocation, {
            pathname:
              router.stripBasename(nextLocation.pathname, basename) ||
  ...
  function useNavigateStable() {
    let { router: router$1 } = useDataRouterContext(
  ...
  */
  ...
  function RouterProvider(_ref) {
    let { fallbackElement, router: router$1, future } = _ref;
    ...
    React__namespace.useLayoutEffect(
      () => router$1.subscribe(setState),
      [router$1, setState],
    );
    React__namespace.useEffect(() => {
      router.UNSAFE_warning(
        fallbackElement == null || !router$1.future.v7_partialHydration,
      ...
      /*#__PURE__*/ React__namespace.createElement(
        ...
        /*#__PURE__*/ React__namespace.createElement(
          ...
          /*#__PURE__*/ React__namespace.createElement(
            ...
            state.initialized || router$1.future.v7_partialHydration
  ...
  class AwaitErrorBoundary extends React__namespace.Component {
    ...
    render() {
      ...
      if (
        status === AwaitRenderStatus.error &&
        promise._error instanceof router.AbortedDeferredError
      ) {
  ...
  function mapRouteProperties(route) {
    ...
    if (route.HydrateFallback) {
      ...
      Object.assign(updates, {
        hydrateFallbackElement: /*#__PURE__*/ React__namespace.createElement(
    ...
    if (route.ErrorBoundary) {
      ...
      Object.assign(updates, {
        errorElement: /*#__PURE__*/ React__namespace.createElement(
          route.ErrorBoundary,
        ),
